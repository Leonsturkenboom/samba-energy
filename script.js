...
const translations = {
    en: {
        ...
        'assets.card1.desc': 'SAMBA optimizes your charging moments based on energy prices, your own solar generation and grid capacity. Save up to \u20AC700 per charging point per year.',
    ...
    nl: {
        ...
        'assets.card1.desc': 'SAMBA optimaliseert je laadmomenten op basis van energieprijzen, eigen zonne-opwek en aansluit capaciteit. Bespaar tot wel \u20AC700 per laadpunt per jaar.',
        ...
        'assets.card3.desc': 'Van warmtepompen, boilers, koelcellen tot vorkheftrucks: SAMBA bewaakt en stuurt al je flexibele assets aan op basis van energieprijzen, eigen zonne-opwek en aansluit capaciteit. Bespaar hiermee tot wel 50% op je energiekosten.',
