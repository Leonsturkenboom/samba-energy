...
const translations = {
    en: {
        ...
        'assets.card2.desc': 'Maximize the use of your own solar generation. SAMBA monitors real-time energy flow between your solar system, grid connection and assets, and automatically controls assets during solar hours. SAMBA monitors your grid limit and timely switches off your solar system during negative prices or impending transport penalties.',
        'assets.card3.title': 'Battery system',
        'assets.card3.desc': 'Focus on optimizing your own consumption. SAMBA first controls your flexible assets during cheap and green moments, reducing your required battery capacity by 50\u201370%. Our AI forecasting algorithm then optimizes the remaining battery usage based on price predictions and detailed consumption patterns. This significantly reduces the payback period of a battery.',
        'assets.card4.title': 'Other flex assets',
        'assets.card4.desc': 'From boiler tanks, heat pumps, cold storage, chillers, air conditioning to forklift charging. SAMBA monitors and controls the energy consumption of all your flexible assets. We map your assets, calculate the savings potential and automate control based on price signals, solar availability and above all your own process rhythm. Save up to 40% on your energy consumption.',
        'assets.card5.title': 'Ventilation',
        'assets.card5.desc': 'Save up to 20% on ventilation by planning capacity based on air quality, CO\u2082 levels and occupancy. SAMBA monitors indoor air quality and ensures a healthy indoor climate only when needed, without unnecessary heat losses.',
        'assets.card6.title': 'Lighting',
        'assets.card6.desc': 'Reduce lighting-related energy consumption through automatic control based on presence, schedule or outdoor light. SAMBA has detection mechanisms for presence, holiday and out-of-office situations \u2014 so lighting is always purposeful and never burns unnecessarily.',
        'assets.card7.title': 'Security',
        'assets.card7.desc': 'Combine asset management with securing your premises. SAMBA can be used in many ways to secure your building, whether in combination with security notifications, alarms and presence detection.',
    ...
    nl: {
        ...
        'assets.card2.desc': 'Maximaliseer het gebruik van eigen zonne-opwek. SAMBA monitort realtime de energieflow tussen je zonnesysteem, netaansluiting en je assets, en stuurt assets automatisch aan op zonne-uren. SAMBA bewaakt je netlimiet en schakelt je zonnesysteem tijdig uit bij negatieve prijzen of dreigende transportboetes.',
        'assets.card3.title': 'Batterijsysteem',
        'assets.card3.desc': 'Focus op het optimaliseren van je eigen verbruik. SAMBA stuurt eerst je flexibele assets aan op goedkope en groene momenten, waardoor je 50\u201370% minder batterijcapaciteit nodig hebt. Ons AI-forecastingalgoritme optimaliseert vervolgens het resterende batterijgebruik op basis van prijsvoorspellingen en gedetailleerde verbruikspatronen. Dit reduceert de terugverdientijd van een batterij aanzienlijk.',
        'assets.card4.title': 'Andere flex assets',
        'assets.card4.desc': 'Van boilervaten, warmtepompen, koelcellen, chillers, aircos tot het laden van vorkheftrucks. SAMBA monitort en controleert het energieverbruik van al je flexibele assets. We brengen je assets in kaart, berekenen het besparingspotentieel en automatiseren de aansturing op basis van prijssignalen, hoeveelheid zon maar bovenal je eigen procesritme. Bespaar daarmee tot wel 40% op je energieverbruik.',
        'assets.card5.title': 'Ventilatie',
        'assets.card5.desc': 'Bespaar tot 20% op ventilatie door capaciteit te plannen op basis van luchtkwaliteit, CO\u2082-niveaus en bezetting. SAMBA monitort de binnenluchtkwaliteit en zorgt voor een gezond binnenklimaat alleen wanneer dat nodig is, zonder onnodige warmteverliezen.',
        'assets.card6.title': 'Verlichting',
        'assets.card6.desc': 'Verlaag verlichting-gerelateerd energieverbruik door automatische sturing afgestemd op aanwezigheid, tijdschema of licht buiten. SAMBA heeft detectiemechanismen voor aanwezigheid, vakantie- en out-of-office-situaties \u2014 zodat verlichting altijd doelgericht en nooit onnodig brandt.',
        'assets.card7.title': 'Beveiliging',
        'assets.card7.desc': 'Combineer asset management samen met het beveiligen van je pand. SAMBA kan op tal van manieren worden gebruikt om je pand te beveiligen, al dan niet in combinatie met beveiligingsmeldingen, alarm en aanwezigheidsdetectie.',
