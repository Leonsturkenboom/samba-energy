...
const translations = {
    en: {
        ...
        'assets.card1.desc': 'Charge smarter, pay less. SAMBA optimizes your charging moments based on energy prices and your own solar generation \u2014 up to \u20AC700 savings per charging point per year.',
        'assets.card2.title': 'Solar panels',
        'assets.card2.desc': 'Get more out of every sunny minute. SAMBA automatically controls your assets during solar hours and monitors your grid limit, so your own generation is maximally utilized.',
        'assets.card3.title': 'Other flex assets',
        'assets.card3.desc': 'Automatic energy savings, tailored to your process rhythm. From heat pumps to forklifts: SAMBA monitors and controls all your flexible assets based on price signals and solar \u2014 save up to 40% on energy costs.',
        'assets.card4.title': 'Battery system',
        'assets.card4.desc': 'Less battery needed, more return. Thanks to smart control of your flexible assets, you need 50\u201370% less battery capacity and our control ensures your battery pays back significantly faster.',
        'assets.card5.title': 'Ventilation',
        'assets.card5.desc': 'Healthy indoor climate, without waste. SAMBA controls ventilation based on CO\u2082 levels, air quality and occupancy \u2014 only when truly needed. Save up to 20% on energy costs.',
        'assets.card6.title': 'Lighting',
        'assets.card6.desc': 'Always light where needed, never where not. SAMBA detects presence and automatically adjusts lighting to occupancy and schedules.',
        'assets.card7.title': 'Security',
        'assets.card7.desc': 'Smart asset management and building security in one. SAMBA can be flexibly deployed to secure your premises.',
    ...
    nl: {
        ...
        'assets.card1.desc': 'Laad slimmer, betaal minder. SAMBA optimaliseert je laadmomenten op basis van energieprijzen en eigen zonne-opwek \u2014 tot \u20AC700 besparing per laadpunt per jaar.',
        'assets.card2.title': 'Zonnepanelen',
        'assets.card2.desc': 'Haal meer uit elke zonnige minuut. SAMBA stuurt je assets automatisch aan op zonne-uren en bewaakt je netlimiet, zodat je eigen opwek maximaal benut wordt.',
        'assets.card3.title': 'Andere flex assets',
        'assets.card3.desc': 'Automatische energiebesparing, afgestemd op jouw procesritme. Van warmtepompen tot vorkheftrucks: SAMBA bewaakt en stuurt al je flexibele assets aan op basis van prijssignalen en zon \u2014 bespaar tot 40% op energiekosten.',
        'assets.card4.title': 'Batterijsysteem',
        'assets.card4.desc': 'Minder batterij nodig, meer rendement. Dankzij slimme aansturing van je flexibele assets heb je 50\u201370% minder batterijcapaciteit nodig en door onze aansturing verdient je batterij zich aanzienlijk sneller terug.',
        'assets.card5.title': 'Ventilatie',
        'assets.card5.desc': 'Gezond binnenklimaat, zonder verspilling. SAMBA regelt ventilatie op basis van CO\u2082-niveau, luchtkwaliteit en bezetting \u2014 alleen wanneer het echt nodig is. Bespaar tot 20% op energiekosten.',
        'assets.card6.title': 'Verlichting',
        'assets.card6.desc': 'Altijd licht waar nodig, nooit waar niet. SAMBA detecteert aanwezigheid en stemt verlichting automatisch af op bezetting en tijdschema\'s.',
        'assets.card7.title': 'Beveiliging',
        'assets.card7.desc': 'Slim asset management \u00E9n gebouwbeveiliging in \u00E9\u00E9n. SAMBA kan flexibel ingezet worden voor het beveiligen van je pand.',
