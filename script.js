...
const translations = {
    en: {
        ...
        'assets.card1.desc': 'SAMBA optimizes your charging moments based on energy prices and your own solar generation \u2014 up to \u20AC700 savings per charging point per year.',
        ...
        'assets.card3.desc': 'From heat pumps to forklifts: SAMBA monitors and controls all your flexible assets based on price signals and solar \u2014 save up to 40% on energy costs.',
        'assets.card4.title': 'Battery system',
        'assets.card4.headline': 'Less battery needed, more return.',
        ...
        'assets.card5.desc': 'SAMBA controls ventilation based on CO\u2082 levels, air quality and occupancy \u2014 only when truly needed. Save up to 20% on energy costs.',
        'assets.card6.title': 'Lighting',
        'assets.card6.headline': 'Always light where needed, never where not.',
        'assets.card6.desc': 'SAMBA detects presence and automatically adjusts lighting to occupancy and schedules.',
    ...
    nl: {
        ...
        'assets.card1.desc': 'SAMBA optimaliseert je laadmomenten op basis van energieprijzen en eigen zonne-opwek \u2014 tot \u20AC700 besparing per laadpunt per jaar.',
        'assets.card2.title': 'Zonnepanelen',
        'assets.card2.headline': 'Haal meer uit elke zonnige minuut.',
        'assets.card2.desc': 'SAMBA stuurt je assets automatisch aan op zonne-uren en bewaakt je netlimiet, zodat je eigen opwek maximaal benut wordt.',
        'assets.card3.title': 'Andere flex assets',
        'assets.card3.headline': 'Automatische energiebesparing, afgestemd op jouw procesritme.',
        'assets.card3.desc': 'Van warmtepompen tot vorkheftrucks: SAMBA bewaakt en stuurt al je flexibele assets aan op basis van prijssignalen en zon \u2014 bespaar tot 40% op energiekosten.',
        'assets.card4.title': 'Batterijsysteem',
        'assets.card4.headline': 'Minder batterij nodig, meer rendement.',
        ...
        'assets.card5.desc': 'SAMBA regelt ventilatie op basis van CO\u2082-niveau, luchtkwaliteit en bezetting \u2014 alleen wanneer het echt nodig is. Bespaar tot 20% op energiekosten.',
        'assets.card6.title': 'Verlichting',
        'assets.card6.headline': 'Altijd licht waar nodig, nooit waar niet.',
        'assets.card6.desc': 'SAMBA detecteert aanwezigheid en stemt verlichting automatisch af op bezetting en tijdschema\'s.',
        'assets.card7.title': 'Beveiliging',
        'assets.card7.headline': 'Slim asset management \u00E9n gebouwbeveiliging in \u00E9\u00E9n.',
        'assets.card7.desc': 'SAMBA kan flexibel ingezet worden voor het beveiligen van je pand.',
