...
const translations = {
    en: {
        ...
        'hero.subtitle': 'AI-powered platform that monitors your assets, optimises intelligently, simplifies usage, reduces energy costs and keeps you within grid limits.',
    ...
    nl: {
        ...
        'hero.subtitle': 'AI-gestuurd platform dat je assets monitort, slim optimaliseert, het gebruik versimpelt, energiekosten verlaagt en je binnen de netlimiet houdt.',
